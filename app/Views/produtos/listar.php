...
<div class="content-wrapper">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/produtos/listar">Home</a></li>
  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <?php endif; ?>
      <?php if (isset($_GET['alert']) && $_GET['alert'] == "sucessEdit") : ?>
        <div class="row">
          <div class="col-12">
            <div class="alert alert-success alert-dismissible">
              <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
      ...
      <!-- Navbar Search -->
<nav style="display: block; margin: 20px auto;" class="main-header navbar navbar-expand navbar-white navbar-light">
